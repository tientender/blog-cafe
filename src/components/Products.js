                ...
                <section className="page-section">
                    <div className="container">
                        <div className="product-item">
                            ...
                            <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="../../img/products-02.jpeg" alt="..." />
                ...
                <section className="page-section">
                    <div className="container">
                        <div className="product-item">
                            ...
                            <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="../../img/products-03.jpeg" alt="..." />
                            <div className="product-item-description d-flex me-auto">
